...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return await buildMetadata({
    locale,
    title: page?.title ?? t("nav.solutions"),
    description: page?.summary ?? t("pages.solutions.fallbackSummary"),
...
export default async function SolutionsPage() {
  ...
  return (
    <InstitutionalPageView
      page={page}
      fallbackBadge={t("nav.solutions")}
      fallbackTitle={t("nav.solutions")}
      fallbackSummary={t("pages.solutions.fallbackSummary")}
    />
  );
}
